  ...
  return ( 
    ...
    style={{
      ...
      <div className='container mx-auto flex justify-center items-center'>
        ...
        className='shadow-inner w-[300px] h-[200px] 1xl:w-[970px] 1xl:h-[350px] lg:w-[708px] lg:h-[255px] sm:w-[516px] sm:h-[186px]  drop-shadow-xl max-h-[570px] max-w-[947px] bg-[#FFFFFF] rounded-[65.47px] backdrop-blur bg-opacity-30 flex flex-col items-center justify-center gap-9'>
        <div className='p-5'>
