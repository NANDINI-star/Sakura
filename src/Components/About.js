    ...
    <div className='bg-[#D0DDFF] p-10'>
        <div class="wrap w-5/6 mx-auto ">
            ...
            <div class="row-span-full col-start-4 col-end-11 self-center">
                <div class="object-cover rounded-3xl bg-pink-400 h-[550px] w-[778px]"
                style={{
                    ...
                    width: '778px', // Set the width to fill the container
                    height: '570px', // Set the height to fill the viewport
                    }} >
            </div>
            </div>
            <div class="row-span-full col-start-1 col-end-5 self-center w-[492px] h-[353px] p-4 text-white bg-pink-300 to-red-200 rounded-[58px] bg-[#FFE8E8]">
